...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void loadColorFromPrefrences(SharedPreferences sharedPreferences) {
        String colorPrefKey = getString(R.string.pref_color_key);
        String prefColor = getString(R.string.pref_color_red_value);
        mVisualizerView.setColor(sharedPreferences.getString(colorPrefKey, prefColor));
    }
