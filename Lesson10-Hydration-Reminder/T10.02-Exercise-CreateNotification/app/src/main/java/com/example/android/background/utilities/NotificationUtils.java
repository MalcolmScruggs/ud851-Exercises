...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 324532;
    ...
    public static void remindUserBecaseCharging(Context context) {
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setContentIntent(conentIntent(context))
                .setAutoCancel(true);
    ...
    private static PendingIntent conentIntent(Context context) {
    ...
    private static Bitmap largeIcon(Context context) {
        Resources resourcesFromContext = context.getResources();
        return BitmapFactory.decodeResource(resourcesFromContext, R.drawable.ic_local_drink_black_24px);
    }
